...
def pytorch_specific_optimizations():
    ...
    print('Time taken for PyTorch-specific optimizations:', time_taken, 'seconds')

    # Calculate and print memory usage
    process = psutil.Process(os.getpid())
    memory_info = process.memory_info()
    print('Memory usage for PyTorch-specific optimizations:', memory_info.rss / (1024 ** 2), 'MB')